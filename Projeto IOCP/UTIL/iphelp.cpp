...
std::vector<IP_ADAPTER_INFO> stdA::ip_help::getVectorAdaptersInfo()
{
...
std::string stdA::ip_help::toPad(const std::string _s, size_t _num, char _ch_pad)
{
	std::string s = _s;
...
std::string stdA::ip_help::makeMACString(BYTE* _buff, ULONG _size)
{
	std::string s;
	BYTE buff[3];
