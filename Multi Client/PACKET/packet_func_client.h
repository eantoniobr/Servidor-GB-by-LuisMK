...
namespace stdA {
	...
	public:
		...
		static int packet049(void* _arg1, void* _arg2);
		...
		static int packet097(void* _arg1, void* _arg2);
		static int packet0196(void* _arg1, void* _arg2);
		...
		static int packet0230(void* _arg1, void* _arg2);
		static int packet0231(void* _arg1, void* _arg2);
		...
		static void entraSala(player* _session, unsigned short sala_id = 0, std::string senha ="");
