...
#if defined(_WIN32)
		memcpy_s(pri.guild_mark_img, sizeof(pri.guild_mark_img), pd._session.m_pi.gi.Image, sizeof(pri.guild_mark_img));
#elif defined(__linux__)
...
int packet_func::packet0C1(void* _arg1, void* _arg2) {
	...
	try {
		...
		int place = pd._packet->readUint8();	// Att place(lugar)
		pd._session.m_pi.place = place;
...
int packet_func::packet0F4(void* _arg1, void* _arg2) {
	...
	try {
		...
		auto keep = pd._packet->readInt32();
		// TTL = Time To Live
		if (((std::clock() - pd._session.m_tick_bot) / (double)CLOCKS_PER_SEC) >= ((gs->getBotTTL() + (gs->getBotTTL() / static_cast<double>(4))/*TTL time + 1/4 dele*/) / 1000.0))
			_smp::message_pool::getInstance().push(new message("[Warning][Bot Or Lag] Atualiza Time Bot do player: " + std::to_string(pd._session.m_pi.uid) + ", time anterior: " + std::to_string((int64_t)(((std::clock() - pd._session.m_tick_bot) / (double)CLOCKS_PER_SEC) * 1000)) + "ms", CL_ONLY_CONSOLE));
...
int stdA::packet_func::packet186(void* _arg1, void* _arg2)
{
	MAKE_BEGIN_PACKET_SERVER(_arg1, _arg2);
	...
	try {
		...
		if (c != nullptr)
			c->requestPlayBigPapel(pd._session, pd._packet);
...
int packet_func::packet1EB(void* _arg1, void* _arg2)
{
	MAKE_BEGIN_PACKET_SERVER(_arg1, _arg2);
	...
	try {
		...
		if (c != nullptr)
			c->requestOpenScratchCard(pd._session, pd._packet);
...
int packet_func::packet00DD(void* _arg1, void* _arg2) {
	MAKE_BEGIN_PACKET_SERVER(_arg1, _arg2);
...
int packet_func::packet00DE(void* _arg1, void* _arg2) {
	MAKE_BEGIN_PACKET_SERVER(_arg1, _arg2);
	...
	try {
		...
		if (c != nullptr)
			c->requestPlayScratchCardSerial(pd._session, pd._packet);
...
int stdA::packet_func::packet0050(void* _arg1, void* _arg2)
{
	MAKE_BEGIN_PACKET_SERVER(_arg1, _arg2);
	...
	try {
		...
		if (c != nullptr)
			c->requestChangeNickName(pd._session, pd._packet);

	}
	catch (exception& e) {

		_smp::message_pool::getInstance().push(new message("[packet_func::packet_sv050][ErrorSystem] " + e.getFullMessageError(), CL_FILE_LOG_AND_CONSOLE));
...
int packet_func::packet01BC(void* _arg1, void* _arg2)
{
	MAKE_BEGIN_PACKET_SERVER(_arg1, _arg2);

	try {
		sGuildSystem::getInstance().requestCallGuildList(pd._session, pd._packet);
	}
	catch (exception& e) {
...
int packet_func::packet01BD(void* _arg1, void* _arg2)
{
	MAKE_BEGIN_PACKET_SERVER(_arg1, _arg2);

	try {
		sGuildSystem::getInstance().requestCallGuildSearch(pd._session, pd._packet);
	}
	catch (exception& e) {
...
int packet_func::packet01BE(void* _arg1, void* _arg2)
{
	MAKE_BEGIN_PACKET_SERVER(_arg1, _arg2);

	try {
		sGuildSystem::getInstance().requestCallGuildLog(pd._session, pd._packet);
	}
	catch (exception& e) {
...
int packet_func::packet01B8(void* _arg1, void* _arg2)
{
	MAKE_BEGIN_PACKET_SERVER(_arg1, _arg2);

	try {
		sGuildSystem::getInstance().requestCallGuildData(pd._session, pd._packet);
	}
	catch (exception& e) {
...
int packet_func::packet01C6(void* _arg1, void* _arg2)
{
	MAKE_BEGIN_PACKET_SERVER(_arg1, _arg2);

	try {
		sGuildSystem::getInstance().requestCallGuildPlayer(pd._session, pd._packet);
	}
	catch (exception& e) {

		_smp::message_pool::getInstance().push(new message("[packet_func::requestCallGuildPlayer][ErrorSystem] " + e.getFullMessageError(), CL_FILE_LOG_AND_CONSOLE));
	}

	return 0;
};

int packet_func::packet01C4(void* _arg1, void* _arg2)
{
	MAKE_BEGIN_PACKET_SERVER(_arg1, _arg2);

	try {
		sGuildSystem::getInstance().requestCallGuildPromote(pd._session, pd._packet);
	}
	catch (exception& e) {

		_smp::message_pool::getInstance().push(new message("[packet_func::requestCallGuilPromote][ErrorSystem] " + e.getFullMessageError(), CL_FILE_LOG_AND_CONSOLE));
	}

	return 0;
}
int packet_func::packet01C5(void* _arg1, void* _arg2)
{
	MAKE_BEGIN_PACKET_SERVER(_arg1, _arg2);

	try {
		sGuildSystem::getInstance().requestCallGuildNoticeSetPlayer(pd._session, pd._packet);
	}
	catch (exception& e) {

		_smp::message_pool::getInstance().push(new message("[packet_func::requestCallGuildNoticeSetPlayer][ErrorSystem] " + e.getFullMessageError(), CL_FILE_LOG_AND_CONSOLE));
	}

	return 0;
}
int packet_func::packet01B6(void* _arg1, void* _arg2)
{
	MAKE_BEGIN_PACKET_SERVER(_arg1, _arg2);

	try {
		sGuildSystem::getInstance().requestCallGuildCheckName(pd._session, pd._packet);
	}
	catch (exception& e) {

		_smp::message_pool::getInstance().push(new message("[packet_func::requestCallGuildCheckName][ErrorSystem] " + e.getFullMessageError(), CL_FILE_LOG_AND_CONSOLE));
	}

	return 0;
}
int packet_func::packet01B5(void* _arg1, void* _arg2)
{

	MAKE_BEGIN_PACKET_SERVER(_arg1, _arg2);

	try {
		sGuildSystem::getInstance().requestCallGuildCreate(pd._session, pd._packet);
	}
	catch (exception& e) {

		_smp::message_pool::getInstance().push(new message("[packet_func::requestCallGuildCreate][ErrorSystem] " + e.getFullMessageError(), CL_FILE_LOG_AND_CONSOLE));
	}

	return 0;
}
int packet_func::packet00C5(void* _arg1, void* _arg2)
{
	MAKE_BEGIN_PACKET_SERVER(_arg1, _arg2);
...
int packet_func::packet01C0(void* _arg1, void* _arg2)
{

	MAKE_BEGIN_PACKET_SERVER(_arg1, _arg2);

	try {
		sGuildSystem::getInstance().requestCallGuildJoin(pd._session, pd._packet);
	}
	catch (exception& e) {

		_smp::message_pool::getInstance().push(new message("[packet_func::requestCallGuildJoin][ErrorSystem] " + e.getFullMessageError(), CL_FILE_LOG_AND_CONSOLE));
	}

	return 0;
}
int packet_func::packet01CA(void* _arg1, void* _arg2)
{
	MAKE_BEGIN_PACKET_SERVER(_arg1, _arg2);

	try {
		sGuildSystem::getInstance().requestCallGuildAfterUploadMark(pd._session, pd._packet);
	}
	catch (exception& e) {

		_smp::message_pool::getInstance().push(new message("[packet_func::requestCallGuildCallAfterUpload][ErrorSystem] " + e.getFullMessageError(), CL_FILE_LOG_AND_CONSOLE));
	}

	return 0;
}
int packet_func::packet01D1(void* _arg1, void* _arg2)
{
	MAKE_BEGIN_PACKET_SERVER(_arg1, _arg2);

	try {
		sGuildSystem::getInstance().requestCallGuildAccept(pd._session, pd._packet);
	}
	catch (exception& e) {

		_smp::message_pool::getInstance().push(new message("[packet_func::requestCallGuildAccept][ErrorSystem] " + e.getFullMessageError(), CL_FILE_LOG_AND_CONSOLE));
	}

	return 0;
}
int packet_func::packet01D1_2(void* _arg1, void* _arg2)
{
	MAKE_BEGIN_PACKET_SERVER(_arg1, _arg2);

	try {
		sGuildSystem::getInstance().requestCallGuildKick(pd._session, pd._packet);
	}
	catch (exception& e) {

		_smp::message_pool::getInstance().push(new message("[packet_func::requestCallGuildCallKick][ErrorSystem] " + e.getFullMessageError(), CL_FILE_LOG_AND_CONSOLE));
	}

	return 0;
}
int packet_func::packet01C9(void* _arg1, void* _arg2)
{
	MAKE_BEGIN_PACKET_SERVER(_arg1, _arg2);

	try {
		sGuildSystem::getInstance().requestCallGuildUploadMark(pd._session, pd._packet);
	}
	catch (exception& e) {

		_smp::message_pool::getInstance().push(new message("[packet_func::requestCallGuildCallUpload][ErrorSystem] " + e.getFullMessageError(), CL_FILE_LOG_AND_CONSOLE));
	}

	return 0;
}
int packet_func::packet01C1(void* _arg1, void* _arg2)
{
	MAKE_BEGIN_PACKET_SERVER(_arg1, _arg2);

	try {
		sGuildSystem::getInstance().requestCallGuilCancelJoinGuild(pd._session, pd._packet);
	}
	catch (exception& e) {

		_smp::message_pool::getInstance().push(new message("[packet_func::requestCallGuilCancelJoinGuild][ErrorSystem] " + e.getFullMessageError(), CL_FILE_LOG_AND_CONSOLE));
	}

	return 0;
}
int packet_func::packet01BA(void* _arg1, void* _arg2)
{
	MAKE_BEGIN_PACKET_SERVER(_arg1, _arg2);

	try {
		sGuildSystem::getInstance().requestCallGuildChangeNotice(pd._session, pd._packet);
	}
	catch (exception& e) {

		_smp::message_pool::getInstance().push(new message("[packet_func::requestCallGuildChangeNotice][ErrorSystem] " + e.getFullMessageError(), CL_FILE_LOG_AND_CONSOLE));
	}

	return 0;
}
int packet_func::packet01B9(void* _arg1, void* _arg2)
{
	MAKE_BEGIN_PACKET_SERVER(_arg1, _arg2);

	try {
		sGuildSystem::getInstance().requestCallGuildChangeIntro(pd._session, pd._packet);
	}
	catch (exception& e) {

		_smp::message_pool::getInstance().push(new message("[packet_func::requestCallGuildChangeIntro][ErrorSystem] " + e.getFullMessageError(), CL_FILE_LOG_AND_CONSOLE));
	}
...
int packet_func::pacote157(packet& p, player *_session, MemberInfoEx& _mi, unsigned char season) {
	...
	auto capability = _mi.capability;
	auto state = _mi.state_flag;

	_mi.state_flag.stFlagBit.visible = 0;
	if (_mi.capability.ulCapability == 4 || _mi.capability.ulCapability == 15)
	{
	...
	//seta de volta
	_mi.capability = capability;
	_mi.state_flag = state;
	return 0;
};
...
int packet_func::principal(packet& p, PlayerInfo *pi, ServerInfoEx& _si) {
	...
	auto flag = pi->mi.state_flag.ucByte;

	pi->mi.state_flag.ucByte = 128;
	...
	// Config do Server
	p.addUint16(0);				// Esse é o valor 2 que o JP passa, 1 primeira vez que loga, 2 ele já logou uma ou mais vezes
	...
	p.addUint32(363);						// Aqui é a quantidade de vezes que logou
	p.addInt32(_si.propriedade.ulProperty);	// Property do server
	p.addBuffer(&pi->gi, sizeof(GuildInfo));
