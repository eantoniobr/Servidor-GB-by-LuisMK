...
//novos(USA)
			static int packet186(void* _arg1, void* _arg2);	// [Papel Shop] request::Play Big Papel
			static int packet1EB(void* _arg1, void* _arg2);	// abre o scratcard
			static int packet00DD(void* _arg1, void* _arg2);// [Scratch Card] request::Play Scratch Card
			static int packet00DE(void* _arg1, void* _arg2);// [Scratch Card] request::Get Scratch Card Serial		
			static int packet0050(void* _arg1, void* _arg2);// [Change Nick] request::Troca de nick name	
			static int packet01BC(void* _arg1, void* _arg2);// [Guild System] request::Call Guilds info
			static int packet01BD(void* _arg1, void* _arg2);// [Guild System] request::Call Guilds Serach
			static int packet01B8(void* _arg1, void* _arg2);// [Guild System] request::Call Guild Data
			static int packet01BE(void* _arg1, void* _arg2);// [Guild System] request::Call Guild Log
			static int packet01C6(void* _arg1, void* _arg2);// [Guild System] request::Call Guild player
			static int packet01C4(void* _arg1, void* _arg2);// [Guild System] request::Call Guild promote

			static int packet01C5(void* _arg1, void* _arg2);// [Guild System] request::Call Guild Message
			static int packet01B6(void* _arg1, void* _arg2);// [Guild System] request::Call Guilds info
			static int packet01B5(void* _arg1, void* _arg2);// [Guild System] request::Call Guilds Serach
			static int packet00C5(void* _arg1, void* _arg2);// [Guild System] request::Call Guild Data
			static int packet01C0(void* _arg1, void* _arg2);// [Guild System] request::Call Guild Log
			static int packet01C1(void* _arg1, void* _arg2);// [Guild System] request::Call Guild Log
			static int packet01CA(void* _arg1, void* _arg2);// [Guild System] request::Call Guild Log
			static int packet01D1(void* _arg1, void* _arg2);// [Guild System] request::Call Guild player
			static int packet01D1_2(void* _arg1, void* _arg2);// [Guild System] request::Call Guild Kick
			static int packet01C9(void* _arg1, void* _arg2);// [Guild System] request::Call Guild promote
			static int packet01BA(void* _arg1, void* _arg2);// [Guild System] request::Call Guild promote
			static int packet01B9(void* _arg1, void* _arg2);// [Guild System] request::Call Guild promote
// -------------------
			// packet server
