...
#if defined(_WIN32)
				memcpy_s(mi.message, sizeof(mi.message), "PangYa GameRaze", 15);
#elif defined(__linux__)
				memcpy(mi.message, "PangYa GameRaze", 15);
#endif

				if (mascot->msg.active)
#if defined(_WIN32)
					memcpy_s(mi.message, sizeof(mi.message), "PangYa GameRaze!", 16);
#elif defined(__linux__)
					memcpy(mi.message, "PangYa GameRaze!", 16);
#endif
