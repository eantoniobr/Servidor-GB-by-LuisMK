...
namespace stdA {
    class channel {
		...
		public:	// REQUEST FROM CLIENT
			...
			//---------------- novos metodos
			void requestPlayBigPapel(player& _session, packet* _packet);
			//Scratch Card
			void requestOpenScratchCard(player& _session, packet* _packet);
			void requestPlayScratchCard(player& _session, packet* _packet);
			//so fiz pra nao dar dc
			void requestPlayScratchCardSerial(player& _session, packet* _packet);

			void requestChangeNickName(player& _session, packet* _packet);
			//--------------------
			// Msg Chat da Sala
