...
void TourneyBase::updateFinishHole(player& _session, int _option) {
	...
	_smp::message_pool::getInstance().push(new message("[TourneyBase::updateFinishHole][Log] player[UID=" + std::to_string(_session.m_pi.uid) + "] Terminou o hole[NUMERO=" + std::to_string(pgi->hole) + "] Resultado[Score="+ std::to_string(pgi->data.score)+ "].", CL_FILE_LOG_AND_CONSOLE));
